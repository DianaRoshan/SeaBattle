...
int win(Game& player1, Game& player2) {  ïîëå 
	int win1 = 0, win2 = 0;
...
int main() {
	...
	font.loadFromFile("C:\\Users\\diana\\OneDrive\\Èçîáðàæåíèÿ\\ÃÓÀÏ\\Êóðñà÷ ÒÏ\\Project1\\comic.ttf");
	...
	while (window.isOpen()) {
		//êîíñòðóêòîð îáðàáîò÷èêà ñîáûòèé
		Event e;
